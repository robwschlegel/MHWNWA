...
# What is the Northwest Atlantic?

![](graph/fig_1.png)

***

# Why do we need to use a new method to find drivers?

* Events are happening too rapidly to spend a year working on them one at a time
* These provide us with a snapshot of what the future ocean will look like
...
- Variable of interest:
  ...
  - Net downward heatflux (Q; W/m2)
  - Mixed layer depth ()
  - Surface wind stres (tau m; )
  - Surface ocean currents (U and V; )
...
<!-- Rather above show how a detected MHW sits over a number of days and how that is cause for the synoptic state -->
<!-- May want to just re-create the panel of figures from the SA work -->
...
- The primary difference in synoptic SST states is a dipole between a warm (cold) Gulf Stream and cold (warm) Labrador Sea 
