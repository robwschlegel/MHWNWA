...
```{r fig-4, out.width='100%', fig.align='center', fig.cap='MHW information for node 9. A) Regions and seasons of occurrence. B) Cumulative intensity and season of occurrence for each MHW. Linear models show range of dates for MHWs and the secular trends in cumulative intensity. C) Max intensity and region of occurrence for each MHW. Linear models show range of dates for MHWs and the secular trends in max intensity.'}
