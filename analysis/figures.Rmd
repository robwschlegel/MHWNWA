...
The following figure shows when in time (x-axis) each MHW in each node occurred, similar to Figure 5 of @Schlegel2017predominant. It also shows what the cumulative intensity of the event is (y-axis) as well as the season of occurrence.
