...
```
As simpleas that we now have a range of results from our SOM experiments. Up next in the [Node summary vignette](https://robwschlegel.github.io/MHWNWA/node-summary.html) we will show the results with a range of visuals.
