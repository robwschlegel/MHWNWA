...
NB: After going through the model output it has become clear that this analysis should be run first with obs/reanaltsis data, and the NAPA model results may be compared against this as desired. To this end it is now necessary to locate and download the following variables as found in the corresponding datasets:

- SST: NOA OISST product; need to process...
- U and V ocean surface vectors: AVISO; need to process...
- Mixed layer depth: GLORYS; downloading...
- Surface heatflux: OAflux; need to download...
- U and V wind surface vectors: ERA-5; need to download...
