...
It appears that the U and V files also contain their corresponding downward stress (`utau` and `vtau`), though with the availability of the W vectors, I don't know that we need these, too.
...
for(i in 1:length(NAPA_files)){
  ...
  NAPA_files_dates <- rbind(date_info, NAPA_vector_files_dates)
}
