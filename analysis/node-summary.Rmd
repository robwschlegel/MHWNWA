...
#                             Conditions = c(""),
#                             stringsAsFactors = F))
# Create indinvidual data.frames for each column
# This is easier for my brain
...
<!-- |----|----------|----------|------------------|-----------------|------------| -->
<!-- |1   |nfs, gsl, cbs |Summer -- Spring, some winter, little Autumn |small - medium |Cyclonic storm drawing warm air southwards |1999 - 2018 | -->
