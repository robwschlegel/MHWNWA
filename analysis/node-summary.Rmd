...
# No Labrador Shelf
som_node_visualise(som_nolab, file_suffix = "_no_ls")

# Na Lab or GSL
som_node_visualise(som_nolabgsl, file_suffix = "_no_ls_gsl")

# Na Lab, 9 nodes
som_node_visualise(som_nolab_9, file_suffix = "_no_ls_3x3", fig_width = 10, col_num = 3)

# Na Lab, 16 nodes
som_node_visualise(som_nolab_16, file_suffix = "_no_ls_4x4", fig_height = 12)

# Na Lab and no moderate events
som_node_visualise(som_nolabmod, file_suffix = "_no_ls_mod", fig_width = 7, fig_height = 6, col_num = 2)

# Na Lab and no events shorter than 14 days
som_node_visualise(som_nolab14, file_suffix = "_no_ls_14", fig_width = 10, col_num = 3)
```
